...
/// User-Agent
const CODEX_USER_AGENT: &str = "bit2-switch-codex-oauth";
...
struct CodexAccountData {
    ...
    /// bit2-switch 都可能轮换 refresh_token 时拒绝从 live 采纳更旧的一代。
    #[serde(default)]
...
impl CodexOAuthManager {
    ...
    /// CLI does not participate in bit2-switch's switch lock and may refresh in
