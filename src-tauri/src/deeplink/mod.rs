//! Deep link import functionality for bit2-switch
//!
//! This module implements the bit2switch:// protocol for importing configurations
...
///
/// Represents a parsed bit2switch:// URL ready for processing.
