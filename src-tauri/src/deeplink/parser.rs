...
//!
//! Parses bit2switch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a bit2switch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// bit2switch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "bit2switch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'bit2switch', got '{scheme}'"
        )));
    }
