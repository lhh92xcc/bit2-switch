...
/**
 * Hermes Agent configuration API (bit2-switch side).
 *
 * bit2-switch intentionally keeps its Hermes surface minimal — deep configuration
 * (model, agent behavior, env vars, skills, cron, logs, analytics) lives in
 * the Hermes Web UI at http://127.0.0.1:9119. bit2-switch only reads the `model`
